...
*/
    ...
    bool isLocalStep = false;

    printPolygon(A);
    //Polygon_2 convex_hull;
    
    minimization_algorithm(A, isLocalStep, 5000,isMaximization);
...
/*
    ...
    Polygon_2 temp = A;
    Polygon_2 convex_hull;
    CGAL::convex_hull_2(A.begin(), A.end(), std::back_inserter(convex_hull));
    
    std::cout << "polygon area " << A.area() << " conv area " << convex_hull.area() << std::endl;
    std::cout << "================================================" << std::endl;
    double init = Energy_of_State_P(A, convex_hull, false);
    std::cout << "Energy is : " << init << std::endl;
    /*
    while(i<7){
        //printPolygon(temp);
        //std::cout << "______________________" << std::endl;
   ...
   // global_transition_step(polygon);
    std::cout << "______________________" << std::endl;
    //std::cout << "a " << a << " b " << b << std::endl;
    CGAL::convex_hull_2(A.begin(), A.end(), std::back_inserter(convex_hull));
    double final = Energy_of_State_P(A,convex_hull, false);
    std::cout << "Energy is : " <<  final << std::endl;
    std::cout << "Metropolis is : " << Metropolis_criterion(init,final, 0.4) << std::endl;
    */
